...
**Feitas: fatias 0 → 8.** As três saídas judiciais + o encerramento do ciclo estão
prontos. A pergunta (d) da Dra. foi respondida em 07-08/09/2026 (só as saídas
aplicáveis, nunca PDF único, nunca forçar as 3) e a fatia 8 saiu.
- **Fatia 11** pode ser puxada pra frente — seu único bloqueio ("fim da rodada sugere,
  não muda sozinho") foi decidido em 03/09/2026.
- **Fatia 12** (opcional) pode entrar a qualquer momento.

**Ainda travadas:**
- **Fatia 9** — pergunta (c) (numeração dos quesitos suplementares: continuar a
  contagem do laudo × reiniciar por ciclo/parte).
- **Fatia 10** — perguntas (a), (b) e (e), todas do fluxo AT. **Também** precisa de
  desenho próprio: documento de AT não é protocolado pelo sistema (a perita reedita até
  o advogado protocolar de fato), então a trava de "versão imutável pós-protocolo" do
  Judicial não se aplica igual na AT.
